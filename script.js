const posts = [
  ...
  },
  {
    ...
    content: [
      ...
      {
        heading: "2. 建立证据地图和章节蓝图",
        paragraphs: [
          "我将参考文献整理为 literature inventory 和 evidence map，用来说明每篇文献可以支撑什么论点，以及适合进入哪个章节。",
          "在这个基础上，我推进了 Chapter 2 Literature Review 的结构和第一版英文草稿，也建立了 Chapter 3 Methodology 的方法蓝图。",
          "这一轮工作让我意识到，论文写作不能只依赖临时灵感，而要把研究问题、文献证据、章节结构和实验计划连接成一个可以持续推进的系统。",
        ],
      },
      {
        heading: "3. 下一步",
        paragraphs: [
          "接下来最重要的任务，是继续推进真实数据处理与仿真实验，让论文从“写得出来”进一步变成“算得出来、解释得清楚”。",
        ],
      },
    ],
  },
